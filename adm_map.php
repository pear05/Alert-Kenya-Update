...
<script>
    ...
    function saveData() {
        ...
        var url = 'location_model.php?confirm_location&id=' + id + '&confirmed=' + confirmed ;
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBEYcOpF8doUaqqaksgFw1W20f-3YyK8bw&callback=initMap">
</script>
